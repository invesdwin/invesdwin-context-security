 ...
 */
@Immutable
public class CipherEncryptionFactoryRandomIV implements IEncryptionFactory {
    ...
    public CipherEncryptionFactoryRandomIV(final ICipherAlgorithm algorithm, final byte[] key) {
