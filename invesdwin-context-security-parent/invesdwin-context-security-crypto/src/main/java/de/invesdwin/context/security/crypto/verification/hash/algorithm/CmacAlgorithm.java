...
public enum CmacAlgorithm implements IHashAlgorithm {
    ...
    public IHash newHash() {
         ...
         * underlying CBC cipher. Note: there isn't really a good reason to use an IV here, use the regular CMac where
         * possible.
         */
        return new SymmetricCipherHash(REFERENCE.newCipher(),
