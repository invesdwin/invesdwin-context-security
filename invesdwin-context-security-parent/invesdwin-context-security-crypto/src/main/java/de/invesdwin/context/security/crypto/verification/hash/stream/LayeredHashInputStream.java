...
@NotThreadSafe
public class LayeredHashInputStream extends ASimpleDelegateInputStream {
    protected final IHash hash;

    public LayeredHashInputStream(final InputStream delegate, final IHash hash, final Key key) {
        super(delegate);
        this.hash = hash;
        hash.init(key);
    }
