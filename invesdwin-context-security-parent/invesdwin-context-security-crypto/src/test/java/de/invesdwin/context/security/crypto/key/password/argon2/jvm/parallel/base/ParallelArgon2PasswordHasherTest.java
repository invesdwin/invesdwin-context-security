...
import de.invesdwin.context.security.crypto.key.password.argon2.jvm.parallel.ParallelArgon2PasswordHasher;
...
@NotThreadSafe
public class ParallelArgon2PasswordHasherTest {
    ...
    public void testParallelisation() {
        ...
        for (int parallelisation = 1; parallelisation <= maxParallelisation; parallelisation++) {
            final ParallelArgon2PasswordHasher argon2 = new ParallelArgon2PasswordHasher(
                    CryptoProperties.DEFAULT_PEPPER, ParallelArgon2PasswordHasher.DEFAULT_TYPE,
                    ParallelArgon2PasswordHasher.DEFAULT_VERSION, ParallelArgon2PasswordHasher.DEFAULT_MEMORY,
                    ParallelArgon2PasswordHasher.DEFAULT_ITERATIONS, parallelisation);
